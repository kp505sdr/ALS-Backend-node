...
import {
  ...
  jobUpade,
  jobdelete,
} from "../controllers/job/jobControllers.js";
import {
  GoogleLoginSuccess,
  GoogleLoginFailure,
} from "../controllers/users/GoogleLoginSuccess.js";
...
import {
  ...
  getSingleFaq,
  updateFaq,
} from "../controllers/faq/faqControllers.js";
import {
  createBlogs,
  deleteBlogs,
  getAllBlogs,
  getSingleBlogs,
  updateBlogs,
} from "../controllers/blog/BlogsControllers.js";
import {
  createEmailConfig,
  deleteEmailConfig,
  getEmailConfig,
  updateEmailConfig,
} from "../controllers/emailConfig/emailConfigController.js";
...
router.get("/admin-auth", authUser, isAdmin, (req, res) => {
  res.status(200).send({ ok: true });
});
